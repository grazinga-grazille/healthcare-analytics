...
```bash
jupyter notebook healthcare_analysis_demo.ipynb
```

Place `Hospital_General_Information.csv` in the project root (same directory as the notebook) before running.

## Tech Stack

- **pandas** — Data manipulation and aggregation
- **SQLite** — In-memory SQL queries for exploratory analysis
...
├── README.md
├── healthcare_analysis_demo.ipynb   # Main analysis notebook
├── Hospital_General_Information.csv # CMS hospital dataset
└── HOSPITAL_Data_Dictionary.pdf     # CMS data dictionary
```

## License

This project uses publicly available CMS data. Refer to [CMS data use policies](https://www.cms.gov/about-cms/agency-information/aboutwebsite/privacy-policy) for terms governing the underlying dataset.
